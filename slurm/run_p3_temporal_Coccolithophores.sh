#!/bin/bash
#SBATCH --job-name=rf_p3t_Coccolithophores
...
echo "P3 temporal CV Coccolithophores started: $(date) on $(hostname)"
echo "SLURM_CPUS_ON_NODE=$SLURM_CPUS_ON_NODE  SLURM_JOB_ID=$SLURM_JOB_ID"
export P3_PFT_FILTER=Coccolithophores
Rscript "$RF_PROJECT_ROOT/R/model_comparison_p3_temporal.R"
echo "P3 temporal CV Coccolithophores finished: $(date)"
